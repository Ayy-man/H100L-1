...
const DocumentStatusBadge: React.FC<DocumentStatusBadgeProps> = ({
  ...
  if (compact) {
    ...
    if (showWarning) {
      return (
        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-white/10 text-white text-xs font-semibold">
    ...
    if (hasAnyDocuments) {
      return (
        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-[#9BD4FF]/10 text-[#9BD4FF] text-xs font-semibold">
          <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
  ...
  return (
    <div className="flex flex-wrap gap-2">
      {/* Action Plan Badge */}
      {hasActionPlan ? (
        <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#9BD4FF]/10 text-[#9BD4FF] text-sm font-semibold">
      ...
      {showWarning && (
        <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/10 text-white text-sm font-semibold">
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
          </svg>
