...
const UpcomingBookingsCard: React.FC<UpcomingBookingsCardProps> = ({
  ...
  const getSessionTypeBadge = (type: string, isRecurring: boolean) => {
    const typeConfig: Record<string, { label: string; className: string }> = {
      group: { label: 'Group', className: 'bg-blue-500/10 text-blue-600 border-blue-500/30' },
      sunday: { label: 'Sunday Ice', className: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30' },
      private: { label: 'Private', className: 'bg-purple-500/10 text-purple-600 border-purple-500/30' },
      semi_private: { label: 'Semi-Private', className: 'bg-orange-500/10 text-orange-600 border-orange-500/30' },
    };
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                {creditBalance > 0
                  ...
                  : 'Buy credits to book training sessions'}
              </p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="flex flex-col items-center justify-center w-14 h-14 rounded-lg bg-primary/10">
                        <span className="text-xs text-muted-foreground uppercase">
                          {new Date(booking.session_date + 'T00:00:00').toLocaleDateString('en-US', { weekday: 'short' })}
                        </span>
                    ...
                    <Button
                      ...
                      title={canCancel ? 'Cancel booking' : 'Cannot cancel within 24 hours'}
                    >
                      <X className="h-4 w-4" />
                    </Button>
                  </div>
